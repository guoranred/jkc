...
namespace Jiepei.ERP.Orders.SubOrders.Dtos
{
    public class ProductPriceInput
    {
        ...
        /// 零件列表
        /// </summary>
        public List<ProductPriceBomVOInput> BomList { get; set; }
    ...
    public class ProductPriceBomVOInput
    {
        ...
        /// 工艺列表
        /// </summary>
        public List<ProductPriceBomCraftVOInput> BomCraftList { get; set; }

    }

    public class ProductPriceBomCraftVOInput
    {
        /// <summary>
        ///工艺编号
        /// </summary>
