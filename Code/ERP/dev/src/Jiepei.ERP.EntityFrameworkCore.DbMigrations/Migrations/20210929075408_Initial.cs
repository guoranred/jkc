    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ChannelId = table.Column<Guid>(type: "uniqueidentifier", nullable: true, comment: "渠道"),
                    Title = table.Column<string>(type: "varchar(300)", nullable: true, comment: "文章标题"),
                    ColumnType = table.Column<string>(type: "varchar(300)", nullable: true, comment: "所属栏目"),
                    ColumnTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "所属栏目id"),
                    ImgPath = table.Column<string>(type: "varchar(300)", nullable: true, comment: "图片路径"),
                    Introduce = table.Column<string>(type: "varchar(200)", nullable: true, comment: "简介"),
                    Author = table.Column<string>(type: "varchar(100)", nullable: true, comment: "作者"),
                    ReleaseTime = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "发布时间"),
                    ReleaseStatus = table.Column<bool>(type: "bit", nullable: false, defaultValue: false, comment: "发布状态"),
                    IsDel = table.Column<bool>(type: "bit", nullable: true, defaultValue: false, comment: "是否删除"),
                    Content = table.Column<string>(type: "varchar(max)", nullable: true, comment: "内容"),
                    Sort = table.Column<int>(type: "int", nullable: false, comment: "排序"),
                    IsSetTop = table.Column<bool>(type: "bit", nullable: false, comment: "是否置顶"),
                    Tag = table.Column<string>(type: "varchar(50)", nullable: true, comment: "标签"),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "varchar(80)", nullable: true, comment: "图片标题信息"),
                    ImageUrl = table.Column<string>(type: "varchar(500)", nullable: true, comment: "图片链接地址"),
                    RedirectUrl = table.Column<string>(type: "varchar(500)", nullable: true, comment: "地址"),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "生效时间"),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "失效时间"),
                    IsEnable = table.Column<bool>(type: "bit", nullable: false, defaultValue: false, comment: "是否启用"),
                    SortOrder = table.Column<int>(type: "int", nullable: false, comment: "显示顺序"),
                    Remark = table.Column<string>(type: "varchar(500)", nullable: true, comment: "备注信息"),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChannelId = table.Column<Guid>(type: "uniqueidentifier", nullable: true, comment: "渠道"),
                    Pid = table.Column<Guid>(type: "uniqueidentifier", nullable: true, comment: "父id"),
                    Code = table.Column<string>(type: "varchar(100)", nullable: true, comment: "栏目编号"),
                    Name = table.Column<string>(type: "varchar(300)", nullable: true, comment: "栏目名称"),
                    Alias = table.Column<string>(type: "varchar(300)", nullable: true, comment: "栏目别名"),
                    Type = table.Column<string>(type: "varchar(max)", nullable: true, comment: "项目类型"),
                    LogoImage = table.Column<string>(type: "varchar(300)", nullable: true, comment: "logo图片"),
                    Remark = table.Column<string>(type: "varchar(1000)", nullable: true, comment: "备注"),
                    ColumnOwnership = table.Column<int>(type: "int", nullable: false, comment: "栏目所属FAQ|新闻|公告"),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarImage = table.Column<string>(type: "varchar(300)", unicode: false, maxLength: 300, nullable: true, comment: "客服头像图片地址"),
                    WeChatImage = table.Column<string>(type: "varchar(300)", unicode: false, maxLength: 300, nullable: true, comment: "客服微信名片图片地址"),
                    QQ = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true, comment: "客服QQ号"),
                    Email = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true, comment: "客服邮箱"),
                    Type = table.Column<int>(type: "int", nullable: false, comment: "客服类型 0客服 1 业务员 2 渠道业务员"),
                    PromoCode = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true, comment: "业务员推广码"),
                    IsOnline = table.Column<bool>(type: "bit", nullable: false, comment: "是否在线"),
                    BusinessLine = table.Column<string>(type: "varchar(32)", nullable: true, comment: "业务线"),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Note = table.Column<string>(type: "varchar(1000)", nullable: true, comment: "备注"),
                    UnitStartPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "单件起步价"),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChannelUserId = table.Column<string>(type: "varchar(36)", nullable: false, comment: "用户编号"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialName = table.Column<string>(type: "varchar(80)", nullable: true, comment: "材料名称"),
                    Surface = table.Column<int>(type: "int", nullable: false, comment: "表面处理"),
                    SurfaceName = table.Column<string>(type: "varchar(80)", nullable: true, comment: "表面处理名称"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductNum = table.Column<int>(type: "int", nullable: false, comment: "产品套数"),
                    AssembleType = table.Column<bool>(type: "bit", nullable: false, comment: "是否成套组装 1是0否"),
                    NeedDesign = table.Column<bool>(type: "bit", nullable: false, comment: "是否需要设计 1是 0否"),
                    ProcessParameters = table.Column<string>(type: "varchar(max)", nullable: true, comment: "工艺参数字符串"),
                    PurchasedParts = table.Column<int>(type: "int", nullable: false, comment: "配件采购 0 不需要 1 自供 2 代采"),
                    PreviewUrl = table.Column<string>(type: "varchar(500)", nullable: true, comment: "3d文件预览地址"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubOrderSheetMetalItem", x => x.Id);
                },
                comment: "钣金订单项目表");
            ...
            migrationBuilder.CreateIndex(
                name: "Index_ArticleList_ChannelId",
                table: "ArticleList",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "Index_Banner_ChannelId",
                table: "Banner",
                column: "ChannelId");
            ...
            migrationBuilder.CreateIndex(
                name: "Index_SubOrderSheetMetalItem_SubOrderId",
