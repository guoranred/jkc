...
{
    public class ERPTenantDatabaseMigrationHandler :
        ...
        ITransientDependency
    {
        ...
        private readonly ILogger<ERPTenantDatabaseMigrationHandler> _logger;

        public ERPTenantDatabaseMigrationHandler(
            IEnumerable<IERPDbSchemaMigrator> dbSchemaMigrators,
            ICurrentTenant currentTenant,
            IUnitOfWorkManager unitOfWorkManager,
            IDataSeeder dataSeeder,
            ITenantStore tenantStore,
            ILogger<ERPTenantDatabaseMigrationHandler> logger)
        {
        ...
        public async Task HandleEventAsync(TenantCreatedEto eventData)
        {
            await MigrateAndSeedForTenantAsync(
                eventData.Id,
                eventData.Properties.GetOrDefault("AdminEmail") ?? ERPConsts.AdminEmailDefaultValue,
                eventData.Properties.GetOrDefault("AdminPassword") ?? ERPConsts.AdminPasswordDefaultValue
            );
        }
        ...
        public async Task HandleEventAsync(TenantConnectionStringUpdatedEto eventData)
        {
            await MigrateAndSeedForTenantAsync(
                eventData.Id,
                ERPConsts.AdminEmailDefaultValue,
                ERPConsts.AdminPasswordDefaultValue
            );
