...
namespace Jiepei.ERP.Migrations
{
    ...
    [Migration("20210522075646_AddMoldOrderMainOrderNo")]
    partial class AddMoldOrderMainOrderNo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jiepei.ERP.Customers.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Jiepei.ERP.Customers.Customers.CustomerAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Jiepei.ERP.Orders.InjectionOrders.InjectionOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("InjectionOrder");

                    b
                        .HasComment("注塑订单");
                });

            modelBuilder.Entity("Jiepei.ERP.Orders.MoldOrders.MoldOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex(new[] { "OrderNo" }, "Index_MoldOrder_OrderNO");

                    b.ToTable("Mold_Order");

                    b
                        .HasComment("模具订单表");
                });

            modelBuilder.Entity("Jiepei.ERP.Orders.MoldOrders.MoldOrderFlow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex(new[] { "OrderNo" }, "Index_MoldFlow_OrderNo");
            ...
            modelBuilder.Entity("Jiepei.ERP.Orders.Orders.Order", b =>
                {
                    ...
                    b.Property<string>("ExterOrderNo")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)")
                        .HasComment("关联外部订单编号");
                    ...
                    b.HasIndex(new[] { "CustomerId" }, "Index_Order_CustomerId");

                    b.HasIndex(new[] { "ExterOrderNo" }, "Index_Order_ExterOrderNo");
